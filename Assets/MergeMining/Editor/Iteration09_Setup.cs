...
public static class Iteration09_Setup
{
    ...
    [MenuItem("Tools/Merge Mining/(Iteration 9) Update Game Scene")]
    public static void UpdateGameScene()
    {
        ...
        AttachFlyEffectSpawner(coinFly, gemFly);

        EditorSceneManager.MarkSceneDirty(EditorSceneManager.GetActiveScene());
        EditorSceneManager.SaveScene(EditorSceneManager.GetActiveScene());
        Debug.Log("Iteration 9: Game scene updated.");
    }
    ...
    private static void AttachFlyEffectSpawner(GameObject coinFly, GameObject gemFly)
    {
        GameObject canvasGo = GameObject.Find("Canvas");
        FlyEffectSpawner spawner = Object.FindObjectOfType<FlyEffectSpawner>();
